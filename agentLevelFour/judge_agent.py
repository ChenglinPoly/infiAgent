...
def create_judge_agent(max_turns: int = 100,task_id:str = "default_agent_task") -> Agent:
    """
    创建一个Judge Agent实例。
    ...
    **Status说明**:
    ...
    del available_tools[available_tools.index('judge_agent')]
...
def run(
    ...
    # 创建Judge Agent实例
    judge_agent = create_judge_agent(max_turns,task_id)
